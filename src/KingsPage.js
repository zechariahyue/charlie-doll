  ...
  return (
    <div className="kings-page">
      ...
      <div className="photo-gallery">
        <button className="arrow-button previous-button" onClick={handlePreviousKing}>&#8249;</button>
        ...
        <button className="arrow-button next-button" onClick={handleNextKing}>&#8250;</button>
      </div>
